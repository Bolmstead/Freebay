...
import PrimarySearchAppBar from "./Components/Navigation/PrimarySearchAppBar.jsx";
import CategoriesBar from "./Components/Navigation/CategoriesBar.jsx";
import AppRoutes from "./Routes.jsx";
import Container from "@mui/material/Container";
import UserContext from "./Context.js";
import Footer from "./Components/Common/Footer.jsx";
import { login as apiLogin, signup as apiSignup, getUser } from "./Api";
...
function App() {
  ...
  async function login(loginData) {
    try {
      const loginToken = await apiLogin(loginData);
      setToken(loginToken);
      return { success: true };
    } catch (errors) {
  ...
  async function signup(data) {
    try {
      const token = await apiSignup(data);
      setToken(token);
      return { success: true };
    } catch (errors) {
      return { success: false, errors };
