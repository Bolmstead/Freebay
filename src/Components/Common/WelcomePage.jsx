    ...
    <Grid container spacing={2} justifyContent="center" alignItems="center">
      ...
      <Grid item xs={10} md={8}>
        ...
        <Typography component="h1" variant="body1" className={classes.bodyText}>
          Click from the categories above or use the search bar to start fake bidding on fake
          products. Each product has an auction time limit and the user with the highest bid at the
          end of the auction, "wins" the product! To see your active bids, notifications, and
          products you've won, click on profile from the top right icon.
        </Typography>
        <br />
        <Typography component="h1" variant="body1" className={classes.bodyText}>
