...
function ProductCard({ product }) {
  ...
  let { id, name, startingBid, imageUrl, rating, auctionEndDt, bidderUsername, bidPrice } = product;
  let bidDisplay;
      ...
      <Card className={classes.root} variant="outlined">
        <CardActionArea>
          ...
          <CardContent style={{ minHeight: "120px" }}>
            ...
            {bidderUsername ? (
              <div>
                <Typography variant="h6" component="p" display="inline" className={classes.price}>
                  ${bidDisplay}
                  {"  "}
                </Typography>
